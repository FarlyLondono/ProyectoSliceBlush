...
<div class="container mt-4">
    ...
    <div id="formContent">
    <div class="card-bordy">
    <table class="table center" id="listadoPedidos" >
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td><input width="15%" type="number" min="1" class="form-control" name="cantidad" id="cantidad" onkeypress="calcularValorDetalle()" onkeyup="calcularValorDetalle()" onkeydown="calcularValorDetalle()" onclick="calcularValorDetalle(),calcularValorTotal()" value="<?php echo number_format( $producto['cantidad']);?>"></td>
                            <td><input width="20%" type="text" class="form-control" name="precio" id="precio"  readonly value="<?php echo ($producto['precio']);?>"></td> 
                            <td><input width="20%" class="form-control" name="valorDetalle" id="valorDetalle" readonly></td>
                            <td width="5%">
                        ...
                        <tr>
                            ...
                            <td><input align="right" class="form-control" name="valorDetalle" id="valorDetalle" readonly/></td>
                            <td></td>
                        </tr>
...
<?php } ?>
    ...
    <script >
        ...
        {
            let subTotal = $("#valorDetalle").val();
            $("#Total").val(subTotal,2);
        }
