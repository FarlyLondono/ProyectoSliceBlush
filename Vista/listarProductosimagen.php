    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            ?>
                    ...
                    <div class="col-3">
                        <div class="card">
                            <img title="<?php echo $C->getNombreProducto(); ?>" alt="<?php echo $C->getNombreProducto(); ?>" class="card-img-top" src="<?php echo $C->getimagen(); ?>" data-toggle="popover" data-trigger="hover" data-content="<?php echo $C->getDescripcionProducto(); ?>" height="250px">
                            <div class="card-body">
