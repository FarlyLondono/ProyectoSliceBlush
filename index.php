  ...
  <div id="logear">
    ...
    <div class="login">
      ...
      <form action="Controlador/ControladorLogin.php" method="POST">
        ...
        <p class="message">No estas registrado? <a style="color: blue;" class="pointer"  href="Vista/RegistrarCliente1.php">Crea una cuenta</a></p>
        <br/>
        <button type="submit"  class="btn btn-dark" name="Acceder" value="Acceder">Acceder</button><br />
        <a class="pointer" style="color: rgb(17, 0, 255);" href="Vista/RecuperarContrasena.php">Olvide mi contraseña!</a>
        </form>
        <br/>
      </div>
    </div>
